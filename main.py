...
def set_page_config():
    st.set_page_config(
      ...
      menu_items={'About': """# This dashboard app is created by `KA!`
...
def selection():
     ...
     return selected
def Home():
        st.image("https://hindubabynames.info/downloads/wp-content/themes/hbn_download/download/banking-and-finance/phonepe-logo.png", width=260)
...
def Explore_Data():
        ...
        if Type == "Transactions":
            ...
            with col1:
                ...
                df2 = pd.read_csv(r'C:/Users/karth/Downloads/Statenames.csv')
                df1.State = df2
